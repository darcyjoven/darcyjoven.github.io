/*!
  Highlight.js v11.9.0 (git: 21b929a8fc)
...
;function j(e,n,t=F){const a=Object.create(null)
;return"string"==typeof e?i(t,e.split(" ")):Array.isArray(e)?i(t,e):Object.keys(e).forEach((t=>{
Object.assign(a,j(e[t],n,t))})),a;function i(e,t){
n&&(t=t.map((e=>e.toLowerCase()))),t.forEach((n=>{const t=n.split("|")
;a[t[0]]=[e,U(t[0],t[1])]}))}}function U(e,n){
return n?Number(n):(e=>z.includes(e.toLowerCase()))(e)?0:1}const P={},q=e=>{
...
const a=v.classNameAliases[e[t]]||e[t],i=n[t];a?g(i,a):(A=i,c(),A=""),t++}}
function b(e,n){
...
return 0===O.matcher.regexIndex?(A+=e[0],1):(D=!0,0)}function h(e){
...
let y={};function w(a,r){const o=r&&r[0];if(A+=a,null==o)return d(),0
...
;if(!v)throw q(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const k=Q(v);let x="",O=r||k;const M={},S=new p.__emitter(p);(()=>{const e=[]
...
;T=e.index+n}w(t.substring(T))}return S.finalize(),x=S.toHTML(),{language:e,
value:x,relevance:C,illegal:!1,_emitter:S,_top:O}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{language:e,value:J(t),
illegal:!0,relevance:0,_illegalBy:{message:n.message,index:T,
context:t.slice(T-100,T+100),mode:n.mode,resultSoFar:x},_emitter:S};if(s)return{
...
w&&v()}),!1),Object.assign(t,{highlight:h,highlightAuto:E,highlightAll:v,
highlightElement:y,
...
}},i={$pattern:_e,keyword:he,literal:fe,built_in:Ne,"variable.language":ve
...
illegal:/%/},v={
match:n.concat(/\b/,(N=[...we,"super","import"],n.concat("(?!",N.join("|"),")")),t,n.lookahead(/\(/)),
...
className:"operator",
begin:/[-+*/=%^~]|(or|is|mod|not)|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,
relevance:0}]}},grmr_bash:e=>{const n=e.regex,t={},a={begin:/\$\{/,end:/\}/,
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},me,r]}},grmr_javascript:ke,
...
},{begin:/[$%@][^\s\w{=]|\$=/,relevance:0}],contains:[s]},l={className:"number",
...
;const v=[E,f,e.C_BLOCK_COMMENT_MODE,c,d,_];return{case_insensitive:!1,
keywords:m,contains:[{begin:n.concat(/#\[\s*/,i),beginScope:"meta",end:/]/,
endScope:"meta",keywords:{literal:g,keyword:["new","array"]},contains:[{
begin:/\[/,end:/]/,keywords:{literal:g,keyword:["new","array"]},
contains:["self",...v]},...v,{scope:"meta",match:i}]
...
relevance:0},{match:/\bor\b/,scope:"keyword"},l,b,e.HASH_COMMENT_MODE,{
...
contains:[u,m,l]}]}},grmr_python_repl:e=>({aliases:["pycon"],contains:[{
...
match:[/\./,m(...Oe,...Me)],className:{2:"keyword"}},r={match:b(/\./,m(...Ae)),
relevance:0},s=Ae.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Se).map(xe),...Me)}]},l={
...
contains:[...x,{scope:"comment",begin:`#(?!.*${t})`,end:/$/}]}},S={
scope:"regexp",variants:[M("###"),M("##"),M("#"),O]},A={match:b(/`/,Fe,/`/)
},C=[A,{className:"variable",match:/\$\d+/},{className:"variable",
match:`\\$${ze}+`}],T=[{match:/(@|#(un)?)available/,scope:"keyword",starts:{
contains:[{begin:/\(/,end:/\)/,keywords:Pe,contains:[...p,f,k]}]}},{
scope:"keyword",match:b(/@/,m(...Ue))},{scope:"meta",match:b(/@/,Fe)}],R={
...
;n.keywords=l;const t=[...c,...g,...p,f,k,...C];n.contains=[...t,{begin:/\(/,
end:/\)/,contains:["self",...t]}]}return{name:"Swift",keywords:l,
contains:[...a,$,z,{beginKeywords:"struct protocol class extension enum actor",
end:"\\{",excludeEnd:!0,keywords:l,contains:[e.inherit(e.TITLE_MODE,{
className:"title.class",begin:/[A-Za-z$_][\u00C0-\u02B80-9A-Za-z$_]*/}),...c]
},F,j,{beginKeywords:"import",end:/$/,contains:[...a],relevance:0
},S,...c,...g,...p,f,k,...C,...T,R,I]}},grmr_typescript:e=>{
const n=ke(e),t=_e,a=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],i={
...
literal:fe,built_in:Ne.concat(a),"variable.language":ve},o={className:"meta",
...
aliases:["yml"],contains:l}}});const Ke=ae;for(const e of Object.keys(qe)){
